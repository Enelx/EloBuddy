...
namespace Ex1L_Riven.Base
{
    internal class MenuDesigner
    {
        ...
        public static void Initialize()
        {
            ...
            ComboUi.Add("UseR", new KeyBind("Use R in combo", true, KeyBind.BindTypes.PressToggle, 'K'));
            ComboUi.Add("UseFlash", new CheckBox("Use Flash in burst"));
            ComboUi.AddSeparator();
            ComboUi.AddGroupLabel("Combos - Normal | Burst");
            ComboUi.AddLabel("R2 range draw = [Green] - Normal | [Red] - Burst");
            ...
            EmoteUi.Add("Q1Q2delay", new Slider("Select Q1 / Q2 delay", 293, 1, 400));
            EmoteUi.Add("Q3delay", new Slider("Select Q3 delay", 393, 1, 500));
            ...
            DrawUi = RivenUi.AddSubMenu("Draw");
            DrawUi.Add("Rstatus", new CheckBox("Draw R1 status"));
            DrawUi.Add("Rrange", new CheckBox("Draw R2 range"));
        }
    }
}