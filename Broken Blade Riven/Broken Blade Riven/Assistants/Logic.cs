...
namespace Broken_Blade_Riven.Assistants
{
    public static class Logic
    {
        ...
        /// <summary>
        ///     Check if can AA the target
        /// </summary>
        /// <param name="target">Target to check</param>
        /// <returns></returns>
        public static bool IsInAaRange(this Obj_AI_Base target)
        {
            return target.IsInAutoAttackRange(Player.Instance) && target.IsNotNull();
        }

        /// <summary>
        ///     Execute the AA on the target
        /// </summary>
        /// <param name="target">Target to AA</param>
        public static void Autoattack(this Obj_AI_Base target)
        {
            if (IsInAaRange(target))
            {
