...
namespace Broken_Blade_Riven.Assistants
{
    public static class Return
    {
        ...
        // Force R1
        public static bool UseForceR1
        {
            get { return GetCheckbox(MenuDesigner.ComboUi, "ForceR"); }
        }

        // Combo Flash
        public static bool UseComboFlash
        {
            get { return GetKeybind(MenuDesigner.ComboUi, "ComboFlash"); }
        }
